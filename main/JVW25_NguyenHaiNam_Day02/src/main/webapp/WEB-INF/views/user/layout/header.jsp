			...
			<div class="row">
				<div class="col-lg-3 col-md-4 col-6">
					<div class="header__bottom-logo">
						<a href="#"><img src="${classpath}/user/./img/logo.jpg"
				...
				<div class="col-lg-6 block none">
					<div class="header__bottom-menu">
						<ul>
							...
							<li class="header__bottom-menu-children"><a
								href="${classpath}/danhmuc">Thú cưng</a>
								<ul class="mega__subnav">
									<li class="mega__subnav-menu">
										...
										<ul class="mega__subnav-menu-2">
											...
											<li><a href="${classpath}/danhmuc">Chó Alaska
													Malamute</a></li>
											<li><a href="${classpath}/danhmuc">Chó Golden
													Retriever</a></li>
											<li><a href="${classpath}/danhmuc">Chó Husky
													Siberian</a></li>
											<li><a href="${classpath}/danhmuc">Chó Phốc Sóc –
													Pomeranian</a></li>
										</ul>
									</li>
									<li class="mega__subnav-menu">
										...
										<ul class="mega__subnav-menu-2">
											<li><a href="${classpath}/danhmuc">Mèo Anh (Dài +
													Ngắn)</a></li>
							...
							<li class="header__bottom-menu-children"><a
								href="${classpath}/lienhe">Liên hệ</a></li>
						</ul>
					</div>
				</div>
				<div class="col-lg-3 col-md-8 col-6">
					<div class="header__bottom-actions">
						...
						<div class=" header__bottom-btn header__bottom-cart">
							<a href="${classpath}/cart-view"><i class='bx bx-cart'></i></a> <span
								...
								<div class="header__bottom-box-cart">
									<div class="header__cart-products">
										...
										<div class="cart-product-inner">
											<div class="cart-product__main">
												<div class="cart-product__thumb">
													<img src="${classpath}/user/./img/products/1.jpg"
														class="cart-product-img">
												</div>
												<div class="cart-product__content">
													<a href="${classpath}/sanpham">
